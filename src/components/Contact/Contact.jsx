...
const Contact = () => {
  ...
  return (
    <section id="contact" className="contact-section">
      <h2 className="contact-title"><span>Get in Touch</span></h2>
      ...
      <div className="glass-wrapper">
        ...
        <form ref={form} onSubmit={handleSubmit} className="glass-card contact-form">
          <label>Your Name</label>
          ...
          <label>Write your message here</label>
          <textarea name="doubt" rows="6" placeholder="Enter your message" required></textarea>
